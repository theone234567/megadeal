...
const FAQS = [
  ...
  {
    q: "Will customers see my deal if they're nearby?",
    a: "📍 Yes — customers can sort deals by \"Nearest to me\", so setting an accurate pin on the map when you sign up genuinely matters: it's what puts your deal in front of the people closest to you first.",
  },
  {
      ...
      <section id="hero" className="relative overflow-hidden bg-brand-700 px-4 py-16 text-center sm:px-6 lg:px-8">
        <div className="relative mx-auto max-w-3xl">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-brand-50">
            ...
            We&apos;re launching in Auckland first, before expanding
            across the rest of NZ, and early businesses who join us
            from day one get up to 3 months free advertising.
            Conditions apply.
          </p>
