...
export default function ComingSoonPage() {
  return (
    <main className={`${plusJakartaSans.className} overflow-hidden bg-white text-[#2d136f]`}>
      <section className="relative px-5 pb-4 pt-5 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-[1440px]">
          <div className="grid items-start gap-8 lg:grid-cols-[0.46fr_0.54fr] lg:gap-0">
            <div className="relative z-20 pt-4 lg:pt-8">
              <p className="text-xs font-extrabold uppercase tracking-[0.28em] text-[#ef159d] sm:text-sm">
                Coming soon
              </p>
              <h1
                className={`${fredoka.className} mt-3 max-w-[650px] text-[44px] font-bold leading-[0.94] tracking-[-0.045em] text-[#35117e] sm:text-[59px] lg:text-[64px] xl:text-[68px]`}
              >
              ...
              <div className="relative z-30 mt-5 grid gap-3 sm:grid-cols-2 lg:w-[112%] xl:w-[116%]">
                <div className="flex min-h-[205px] flex-col rounded-[18px] bg-gradient-to-br from-[#fbf7ff] to-[#f4efff] p-5 shadow-[0_8px_24px_rgba(71,28,146,0.05)] sm:p-6">
                  ...
                  <h2 className={`${fredoka.className} mt-3 text-center text-[25px] font-bold leading-tight text-[#35117e] sm:text-left`}>
                    Love a good deal?
                  </h2>
                ...
                <div className="flex min-h-[205px] flex-col rounded-[18px] bg-gradient-to-br from-[#fffaf8] to-[#fff3ed] p-5 shadow-[0_8px_24px_rgba(71,28,146,0.04)] sm:p-6">
                  ...
                  <Link
                    ...
                    className="mt-4 inline-flex items-center justify-center rounded-full bg-gradient-to-r from-[#661cf0] to-[#8e27ff] px-5 py-3 text-sm font-extrabold text-white transition hover:brightness-95"
                  >
                    List my business →
                  </Link>
                </div>
            ...
            <div className="relative z-10 -mt-2 min-h-[600px] lg:-mt-16 lg:min-h-[680px] xl:-mt-20 xl:min-h-[710px]">
              <div className="absolute inset-x-0 top-0 mx-auto aspect-[1.04/1] w-[97%] overflow-hidden rounded-[48%_52%_48%_52%/36%_38%_62%_64%] bg-[#eee7ff] lg:right-[-3%] lg:w-[104%]">
                <img
                  src={AUCKLAND_IMAGE}
                  alt="Auckland waterfront with the city skyline and sailboats"
              ...
              <p className={`${caveat.className} absolute bottom-[2%] right-[0%] hidden max-w-[180px] rotate-[-8deg] text-center text-2xl font-bold leading-[0.95] text-[#35117e] xl:block`}>
                Local deals from local businesses. For Auckland.
                <span className="ml-2 text-[#ff2ca7]">♡</span>
              </p>
            </div>
          </div>
          ...
          <div className="relative z-30 -mt-8 grid gap-y-4 border-t border-[#eee8f7] bg-white pt-5 sm:grid-cols-2 lg:-mt-14 lg:grid-cols-4 lg:gap-x-0 xl:-mt-16">
            <div className="flex items-center gap-3 lg:border-r lg:border-[#ddd6eb] lg:pr-6">
              <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#e8fbf4] text-[#14a36c]">
            ...
            <div className="flex items-center gap-3 lg:border-r lg:border-[#ddd6eb] lg:px-6">
              <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#ffe8f4] text-[#f118a1]">
      ...
      <section className="px-5 py-4 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-[1440px] rounded-[18px] bg-gradient-to-r from-[#f7f2ff] via-[#f3edff] to-[#faf5ff] px-5 py-5 sm:px-7 lg:px-8 lg:py-6">
          <div className="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
            <h2 className={`${fredoka.className} text-3xl font-bold tracking-[-0.03em] text-[#35117e] sm:text-[36px]`}>
            ...
            {[
              ...
              return (
                <div key={String(title)} className="contents">
                  <div className="grid grid-cols-[38px_52px_1fr] items-center gap-3">
                    <span className="flex h-9 w-9 items-center justify-center rounded-full bg-[#7221f0] text-sm font-extrabold text-white">
                      {number as string}
                    </span>
              ...
              return (
                <div key={category.label}>
                  <div className="relative aspect-[1.48/1] overflow-hidden rounded-[14px] bg-slate-100">
                    ...
                    />
                    <span className="absolute -bottom-1 left-1/2 flex h-10 w-10 -translate-x-1/2 items-center justify-center rounded-full border-[4px] border-white bg-white text-[#7022ee] shadow-sm">
      ...
      <section id="get-notified" className="scroll-mt-24 px-5 py-3 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-[1440px] rounded-[18px] bg-gradient-to-r from-[#f8f3ff] via-[#fbf7ff] to-[#f7efff] px-5 py-5 sm:px-7 lg:grid lg:grid-cols-[1fr_0.55fr] lg:items-center lg:gap-8 lg:px-8">
          <div>
            ...
            <p className="mt-1 max-w-3xl text-sm leading-6 text-[#4a426b] sm:text-base">
            ...
            <div className="mt-3 max-w-3xl">
              <EmailSignupForm
                ...
                surface="plain"
              />
              <div className="mt-2 flex flex-wrap gap-x-5 gap-y-1 text-xs font-semibold text-[#675e80]">
          ...
          <div className="relative mt-5 hidden min-h-[100px] lg:block" aria-hidden>
            ...
            <p className={`${caveat.className} absolute right-[2%] top-[8%] rotate-[-7deg] text-3xl font-bold leading-[0.9] text-[#3d1a9d]`}>
              Be part from
              <br />
              the beginning.
              <span className="ml-1 text-[#ff2ca7]">♡</span>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-5 pb-5 pt-2 sm:px-8 lg:px-10">
        <div className="mx-auto grid max-w-[1440px] gap-4 lg:grid-cols-[1.6fr_1fr]">
          <div className="rounded-[18px] bg-gradient-to-br from-[#fff4fb] via-[#fbf3ff] to-[#f6efff] p-5 sm:p-7 lg:p-8">
            ...
            <h2 className={`${fredoka.className} mt-2 text-[38px] font-bold leading-[0.92] tracking-[-0.035em] text-[#35117e] sm:text-[50px]`}>
              Fill quiet times.
              <br />
              Get more customers.
            </h2>
              ...
              <div className="rounded-[17px] bg-white p-5 shadow-[0_7px_26px_rgba(80,39,144,0.07)]">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className={`${fredoka.className} text-[44px] font-bold leading-none text-[#ef159c] sm:text-[50px]`}>6 months</p>
                    <p className={`${fredoka.className} mt-1 text-[25px] font-bold leading-none text-[#35117e]`}>
                      advertising free.*
                    </p>
                  </div>
                </div>
          ...
          <div className="relative overflow-hidden rounded-[18px] bg-gradient-to-br from-[#faf6ff] to-[#f5efff] p-5 sm:p-7 lg:p-8">
            ...
            <p className={`${caveat.className} absolute right-4 top-16 hidden max-w-[180px] rotate-[-7deg] text-right text-[27px] font-bold leading-[0.95] text-[#3f1aa8] sm:block`}>
              More local deals across New Zealand coming soon.
            </p>
            <div className="absolute bottom-4 right-7 hidden text-[62px] font-black tracking-[-0.08em] text-[#decaff] sm:block" aria-hidden>
              NZ
            </div>
          </div>
        </div>
