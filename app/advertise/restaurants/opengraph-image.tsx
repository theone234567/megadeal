...
// ("New Zealand's daily deals site...") instead of what this specific
// page is actually offering restaurant owners.
...
export default function RestaurantsOpengraphImage() {
